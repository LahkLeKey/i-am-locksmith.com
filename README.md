...
For the locksmith deployment on `i-am-locksmith.com`, see [docs/client-demo-auth-runbook.md](docs/client-demo-auth-runbook.md) for the required Clerk env vars, preview/prod redirect expectations, and smoke checklist.

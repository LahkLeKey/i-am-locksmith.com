...
import {JobService, JobWorkflowService, QuoteService} from './services';
  ...
  describe('JobService', () => {
    ...
    describe('canTransitionToStatus', () => {
      it('allows valid transitions', () => {
        expect(JobService.canTransitionToStatus('queued', 'scheduled'))
            .toBe(true);
      ...
      it('prevents invalid transitions', () => {
        expect(JobService.canTransitionToStatus('closed', 'queued'))
            .toBe(false);
        expect(JobService.canTransitionToStatus('queued', 'closed'))
            .toBe(false);
      });
    });
